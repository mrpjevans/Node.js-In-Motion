...
router.get('/weather', async (req, res, next) => {
    ...
    const wundergroundUri = `${config.wunderground.uri}${config.wunderground.apikey}/conditions/q/${config.wunderground.city}.json`;
    const weather = await request.get({uri: wundergroundUri, json: true});
    res.json(weather);
